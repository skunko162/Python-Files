...
def new_recipe_form():
    ...
    return render_template('new_item.html', log_user=log_user)
...
def one_recipe(id):
    ...
    return render_template('view_item.html', this_item=this_item)
...
def edit_recipe(id):
    ...
    return render_template("item_update.html", this_item=this_item)
